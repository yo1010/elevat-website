...
import contractImg from '../public/img/contract.jpg';
import procurementImg from '../public/img/procurement.jpg';
import constructionImg from '../public/img/construction.jpg';
        ...
        return (
            <React.Fragment>
                ...
                <div className="container">
                    <CardItem content={
                        <React.Fragment>
                            <div className="col-10 col-sm-4 col-md-4 col-lg-4 mt-4 colContainer" data-aos="fade-left" data-aos-duration="500">
                                <div className="imgContainer">
                                    <img src={corporateImg}/>
                                </div>
                            </div>
                            <div className="ml-auto mr-5 card mt-5 firstCard" data-aos="fade-right" data-aos-duration="500">
                    ...
                    <CardItem content={
                        <React.Fragment>
                            <div className="mr-auto card mt-5 secondCard" data-aos="fade-left" data-aos-duration="500">
                            ...
                            <div className="col-10 col-sm-4 col-md-4 col-lg-4 mt-4 ml-0 colContainer" data-aos="fade-right" data-aos-duration="500">
                                <div className="imgContainer rightImgContainer">
                                    <img src={contractImg} className="rightImg"/>
                                </div>
                            </div>
                        </React.Fragment>
                    }/>
                    <CardItem content={
                        <React.Fragment>
                            <div className="col-10 col-sm-4 col-md-4 col-lg-4 mt-4 ml-0 colContainer" data-aos="fade-left" data-aos-duration="500">
                                <div className="imgContainer">
                                    <img src={constructionImg}/>
                                </div>
                            </div>
                            <div className="ml-auto mr-5 card mt-5 thirdCard" data-aos="fade-right" data-aos-duration="500">
                    ...
                    <CardItem content={
                        <React.Fragment>
                            ...
                            <div className="col-10 col-sm-4 col-md-4 col-lg-4 mt-4 ml-0 colContainer" data-aos="fade-right" data-aos-duration="500">
                                <div className="imgContainer rightImgContainer">
                                    <img src={procurementImg} className="rightImg"/>
                                </div>
                            </div>
                        </React.Fragment>
                    }/>
